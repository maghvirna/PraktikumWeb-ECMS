                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    if (isset($_GET['aksi']) == 'delete') {
                                        $kds = $_GET['kd_staff'];
                                        $cek = mysqli_query($koneksi, "SELECT * FROM staff WHERE kd_staff='$kds'");
                                        if (mysqli_num_rows($cek) == 0) {
                                            echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan !</div>';
                                        } else {
                                            $delete = mysqli_query($koneksi, "DELETE FROM staff WHERE kd_staff='$kds'");
                                            $delete2 = mysqli_query($koneksi, "DELETE FROM user WHERE username='$kds'");
                                            if ($delete && $delete2) {
                               ...
                               <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='admin.php' class="btn btn-sm btn-success" >Refresh</i></a>
                                ...
                                <div class="box-footer clearfix no-border">
                                    <a href="../member/input-member.php" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Tambah Staff</a>
                                </div>
                            </div><!-- /.box -->
        ...
        <script>
            $(document).ready(function() {
                var dataTable = $('#lookup').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: "../member/ajax-grid-member.php", // json datasource
