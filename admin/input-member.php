      ...
      <div class="content-wrapper">
		...
		/**	if(isset($_POST['input'])){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO karyawan(nik, nama, bagian, k1_join, k1_finish, k2_join, k2_finish, status)
															VALUES('$nik','$nama','$bagian','$k1_join','$k1_finish','$k2_join','$k2_finish','$status')") or die(mysqli_error());
						if($insert){
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO karyawan(nik, nama, bagian, k1_join, k1_finish, k2_join, k2_finish, status, gambar) VALUES
                                      ('$nik','$nama','$bagian','$k1_join','$k1_finish','$k2_join','$k2_finish','$status','$gambar')";
			...
			?>
                ...
                <form class="form-horizontal style-form" action="input-member.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="nik" type="text" id="nik" class="form-control" placeholder="Auto Number" autocomplete="off" autofocus="on" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input name="bagian" type="text" id="bagian" class="form-control" placeholder="Bagian" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='k1_join' id="tanggal_beli" placeholder='Kontrak 1 Join' required />
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='k1_finish' id="tanggal_beli" placeholder='Kontrak 1 Finish' required />
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='k2_join' id="tanggal_beli" placeholder='Kontrak 2 Join' required />
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='k2_finish' id="tanggal_beli" placeholder='Kontrak 2 Finish' required />
