...
$query=mysqli_query($conn, $sql) or die("ajax-grid-jadwal-sd.php: get jadwal_sd");
...
$sql.="from jadwal WHERE kategori_kelas='SD'";
	...
	$query=mysqli_query($conn, $sql) or die("ajax-grid-jadwal-sd.php: get jadwal_sd"); // again run query with limit
