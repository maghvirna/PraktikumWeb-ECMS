  ...
  <body class="hold-transition" background="dist/img/2.jpg">
    <div class="login-box">
      <div class="login-logo">
        <a href="index.php" style="color: white;"><b>Login</b>&nbsp;ECMS</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">ECMS (Education Courses Management System)</p>
 ...
 <div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      Education Courses Management System Merupakan Aplikasi Management Bimbingan Belajar Berbasis Web, Aplikasi Ini Masih dalam Pengembangan
      <table>
      <tr>
