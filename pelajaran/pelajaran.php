  ...
  <section class="content">
    ...
    <div class="row">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            if(isset($_GET['aksi']) == 'delete'){
              $kdpel = $_GET['id'];
              $cek = mysqli_query($koneksi, "SELECT * FROM pelajaran WHERE kd_pelajaran='$kdpel'");
              if(mysqli_num_rows($cek) == 0){
               echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan.</div>';
             }else{
               $delete = mysqli_query($koneksi, "DELETE FROM pelajaran WHERE kd_pelajaran='$kdpel'");
               if ($delete) {
      ...
      <div class="box-footer clearfix no-border">
        <a href="input-pelajaran.php" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Tambah Pelajaran</a>
      </div>
    </div><!-- /.box -->
          ...
          <script>
            $(document).ready(function() {
              var dataTable = $('#lookup').DataTable( {
               ...
               "serverSide": true,
               "ajax":{
						url :"ajax-grid-pelajaran.php", // json datasource
